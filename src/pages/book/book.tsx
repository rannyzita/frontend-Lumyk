...
type BookData = {
  ...
  autor: {
    nome: string;
    foto: string; // Adicionando a foto do autor
  };
  sinopse: string;
  estoque: number;
  foto: string; // Foto do livro
  preco: string;
  formato: string;
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Image source={{ uri: bookData.foto }} style={styles.image} />

        <Text style={styles.title}>{bookData.titulo}</Text>
        <Text style={styles.author}>{bookData.autor.nome}</Text>

        {/* Exibição da imagem do autor */}
        <Image 
          source={{ uri: bookData.autor.foto }} 
          style={styles.authorImage} // Estilo para a foto do autor
        />
        ...
        <View style={styles.bottomBox}>
          ...
          <Image source={{ uri: bookData.foto }} style={styles.bottomImage} />
